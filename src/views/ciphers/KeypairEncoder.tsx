...
function KeypairEncoder() {
    ...
    const [eulerFun, setEulerFun] = useState<number>();
    ...
    const handleValidateE = () => {
        if (keyE !== undefined && eulerFun !== undefined) {
    ...
    const handleEncrypt = () => {
        if (!inputText || keyN === undefined || keyE === undefined || !isValidated) return;
    ...
    const handleSelectorChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
        ...
        setEulerFun(val ?? "")
        setValidated(false)
        setValidatedE(undefined)
        setInputText("")
        setEncryptedData([])
        setDecryptedText("")
        setCipherText("")
        if (select === 2) setIsDecipher(true)
        if (select === 1) setIsDecipher(false)
    }
                        ...
                        <div className="flex-1 flex flex-col gap-4">
                            <div className="flex flex-col gap-2">
                                ...
                                <select 
                                    ...
                                    className={`w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 focus:ring-blue-500 bg-white dark:bg-gray-700 focus:outline-none focus:ring-2 transition-all`}
                                >
                                    <option value="1">Cipher</option>
                                    <option value="2">Decipher</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="flex flex-col md:flex-row gap-8">
                            <div className="flex-1 flex flex-col gap-4">
                                <div className="flex flex-col gap-2">
                                    ...
                                    <input
                                        type="text"
                                        placeholder="private exponent generate"
                                        value={keyD}
                                        onChange={(e) => setKeyD(Number(e.target.value))}
                            ...
                            <div className="flex-1 flex flex-col gap-4">
                                <div className="flex flex-col gap-2">
                                    ...
                                    <input
                                        type="text"
                                        placeholder="assembled module base of the prime numbers"
                                        value={keyN}
                                        onChange={(e) => setKeyN(Number(e.target.value))}
                                        className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
                                    />
                                </div>
                            </div>
                                    ...
                                    <div className={`w-full p-4 rounded-lg border flex items-center shadow-sm ${
                                        ...
                                        <span>
                                            <strong className="mr-2">
                                                {isValidated ? "Validated" : "Not validated"}: {validatedE}
                                            </strong>
                                        </span>
                                    </div>
                                )}
