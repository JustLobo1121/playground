...
function BinaryTranslate() {
    ...
    return (
        <div className="min-h-screen p-8 flex flex-col md:flex-row gap-8 bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-100 transition-colors duration-300">
            <div className="flex-1 bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 flex flex-col gap-6">
                <h1 className="text-2xl font-extrabold text-blue-600 dark:text-blue-400 border-b border-gray-200 dark:border-gray-700 pb-2">
